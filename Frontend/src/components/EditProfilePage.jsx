...
//helper function similar to the dashboard page
...
//this function will prevent from the dulicate slots
...
export default function EditProfilePage({ apiBase }) {
  ...
  //to add toast and check for duplicate date and prevent it
  ...
  //same thing prevent duplicate slots and add new slot

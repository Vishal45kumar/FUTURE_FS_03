...
import { appointmentPageStyles,cardStyles,badgeStyles,iconSize } from '../assets/dummyStyles.js'
...
//rhis function will help in getting the status
...
const AppointmentPage = () => {
    ...
    const loadServiceAppointments = useCallback(async () => {
      ...
      const headers = token ? { Authorization: `Bearer ${token}` } : {};
      console.log(
        "Outgoing headers for /api/service-appointments/me:",
        headers,
      );

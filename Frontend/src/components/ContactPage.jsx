...
import { contactPageStyles } from '../assets/dummyStyles.js'
...
const ContactPage = () => {
    ...
    //validates that all fields are filled by user or not
    function validate() {
      const e = {};
    ...
    function handleSubmit(e) {
      ...
      const url = `https://wa.me/9341480104?text=${encodeURIComponent(text)}`;
      ...
      <div className={contactPageStyles.gridContainer}>
        <div className={contactPageStyles.formContainer}>
          ...
          <p className={contactPageStyles.formSubtitle}>
            Fill the form - we'll open Whatsapp so you connect with us instantly
          </p>
          <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            <div className={contactPageStyles.formGrid}>
              <div>
                ...
                />
                {errors.name && (
                  <p clssName={contactPageStyles.error}>{errors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.email && (
                  <p clssName={contactPageStyles.error}>{errors.email}</p>
                )}
              </div>
            </div>
            <div className={contactPageStyles.formGrid}>
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Anandapur , Kolkata , West Bengal
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 9341480104
            </p>
            <p className={contactPageStyles.infoItem}>

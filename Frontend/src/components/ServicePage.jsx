...
import { servicePageStyles, serviceCardStyles } from "../assets/dummyStyles.js";
import { Link } from "react-router-dom";
import { ChevronsRight, MousePointer2Off } from "lucide-react";
import { useClerkToken } from "./useClerkToken.jsx";
...
const ServicePage = ({ previewCount = 9999 }) => {
  ...
  useEffect(() => {
    ...
    console.log("Token in this page:", token);

    // use token here (API call etc.)
  }, [token]);

  //to load services from server side

...
//to convert 12hrs coming from 24h time
...
export default function DashboardPage({ apiBase }) {
  ...
  //to fetch the appointment from the server by id
  ...
  //to reshedule the appointment
//also check whether appt is cancel or completed then we cannot change
//else reshedule it also prevent previous date and time

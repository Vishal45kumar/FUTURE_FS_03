...
import { useClerkToken } from "../components/useClerkToken";
...
export default function ServiceDetail() {
  ...
  //checks if form valid by all field are filled or not
  ...
  const tokenNew = useClerkToken();

  useEffect(() => {
    if (!tokenNew) console.log("Token not get");

    console.log("Token service booking page:", tokenNew);

    // use token here (API call etc.)
  }, [tokenNew]);

...
//Helper functions
//this function returns the data DD-MM-YYYY
...
//this function takes slot with date time and returns date object
...
const AppointmentsPage = () => {
     const isAdmin = true; // checks admin is logged in and is major admin for response send by him.
    ...
    useEffect(() => {
      async function load() {
        ...
        try {
          ...
          setAppointments(items); //fetch all the details present on theDB
        } catch (err) {
    ...
    async function adminCancelAppointment(id) {
      ...
      //dont allow cancel or completed to be overdone

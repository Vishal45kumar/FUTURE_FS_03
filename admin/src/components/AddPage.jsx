...
import { Calendar, CheckCircle, Eye, EyeClosed, Plus, Trash2, Users, XCircle } from 'lucide-react';

//Helper functions
//this function will give outouts in minutes also manages am or pm
...
const AddPage = () => {
    ...
    //compiute todays date in local time zone
    ...
    //it will show a toast for 3 seconds only
    useEffect(() => {

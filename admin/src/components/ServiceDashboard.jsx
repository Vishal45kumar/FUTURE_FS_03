...
//Normalize the backend data coming from the database
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
  ...
  //fetch the service from the databse
  ...
  }, []); //globarl helper to refresh the page and fetch the service again
  ...
  useEffect(() => {
    ...
    //also refersh the tab when becomes visible
      ...
      <div className={serviceDashboardStyles.innerContainer}>
        ...
        <div className={serviceDashboardStyles.search.container}>
          <div className={serviceDashboardStyles.search.inputContainer}>
            <Search size={16} className="text-emarald-700" />
            <input
              type="text"
          ...
          <div className={serviceDashboardStyles.table.body}>
            { loading ? (
                ...
                visibleServices.map((s)=>{
                    const earning = s.completed * s.prices;
                    return (
                      <div
                        key={s.id}
                      ...
                      >
                        {/* for tablet view */}
                        <div
                          className={serviceDashboardStyles.table.tabletView}
                        >
                          <div className="flex items-center gap-3">
                            <div
                              className={
                                serviceDashboardStyles.table.tabletImage
                              }
                            >
                              <img
                                src={s.image}
                          ...
                          <div
                            className={serviceDashboardStyles.table.tabletCell}
                          >
                            {s.totalAppointments}
                          </div>
                          <div
                        ...
                        {/* for desktop view */}
                        <div
                          className={serviceDashboardStyles.table.desktopView}
                        >
                          <div className="col-span-5 flex items-center gap-4">
                            <div
                              className={
                                serviceDashboardStyles.table.desktopImage
                              }
                            >
                              <img
                                src={s.image}
                        ...
                        {/* for mobile view */}
                        <div
                          className={serviceDashboardStyles.table.mobileView}
                        >
                          <div className="flex items-start gap-3">
                            <div
                              className={
                                serviceDashboardStyles.table.mobileImage
                              }
                            >
                              <img
                                src={s.image}

...
export default function ListServicePage() {
  ...
  // Toasts   a toast is a small, temporary notification message that appears on the screen to inform users about an action or event—without interrupting their workflow.
  ...
  //to fetch service from server side
  ...
  //conert array of slots into array objects
  ...
  //gives output with date and time
...
//format the slot from backend ex-DD-MM-YYYY with HH:MM AM/PM
  ...
  //convert slot obj to timestamp in local time
  ...
  //to edit any service we save then for aparticular service

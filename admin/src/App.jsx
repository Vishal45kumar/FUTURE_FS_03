...
function RequireAuth({ children }) {
  ...
  if(!isSignedIn) return(
    <div className="min-h-screen font-momo flex items-center justify-center bg-linear-to-b 
    from-emerald-50 via-green-50 to-emerald-100 px-4">
      <div className="text-center">
        ...
        <div className='flex justify-center'>
          <Link to='/' className="px-4 py-2 text-sm rounded-full bg-emerald-600 text-white shadow-sm hover:bg-emerald-700
          hover:shadow-md transition-all duration-300 ease-in-out animate-bounce-subtle">
            Home
          </Link>
        </div>
      </div>
